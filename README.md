...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rb-latex-decode-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7649&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-latex-decode-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rb-latex-decode` can be installed with:

```
conda install rb-latex-decode
```

It is possible to list all of the versions of `rb-latex-decode` available on your platform with:
